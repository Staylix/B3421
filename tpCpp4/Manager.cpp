...

{
	...
	{
		logFile = argv[argc - 1];
		if (!(logFile.find_first_of('/') == string::npos && logFile.find_first_of('\\') == string::npos && logFile.find_first_of(':') == string::npos && logFile.find_first_of('?') == string::npos && logFile.find_first_of('>') == string::npos && logFile.find_first_of('<') == string::npos && logFile.find_first_of('|') == string::npos && logFile.find_first_of('"') == string::npos))
		{
			cerr << "Invalid character in the log file name." << endl;
			return 1;
		}
